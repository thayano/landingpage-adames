...
export const DoubtComponent = () => {
    return (
        <div className="relative h-screen md:h-[1024px] overflow-hidden">
            <Image
                src={cenario}
                alt="ovelha"
                fill
            ...
            <div className="absolute inset-0 flex items-end justify-center py-10 md:py-20 px-5 md:px-20"> 
                <div className="bg-[#222222] rounded-3xl p-5 md:p-10 lg:p-20 flex flex-col lg:flex-row gap-5 md:gap-8"> 
                    ...
                    <div className="md:px-8"> 
                        <div className="flex-1 flex flex-col text-white gap-4">
                            ...
                            <p className=" text-sm md:text-base text-justify text-gray-400 md:max-w-lg">
